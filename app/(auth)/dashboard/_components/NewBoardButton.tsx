...
export function NewBoardButton({ orgId, disabled }: NewBoardButtonProps) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      className={cn(
        "col-span-1 aspect-[100/127] bg-amber-400 rounded-lg hover:bg-amber-500 flex flex-col items-center justify-center py-6 transition",
        (disabled || pending) &&
    ...
    >
      ...
      <p className="text-sm text-black font-light">New board</p>
    </button>
  );
}
